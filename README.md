...
- Quarto source files (`.qmd`) for website pages  
- Configuration files (e.g., `_quarto.yml`)  
- Stylesheets and static assets  
- Jupyter notebooks used for research and teaching examples  
